...
`http://colab.research.google.com/github/epfml/ML_course/blob/main/labs/exXY/PATH_TO_FILE`

E.g. for the numpy introduction `npprimer.ipynb`:  
[`http://colab.research.google.com/github/epfml/ML_course/blob/main/labs/ex01/npprimer.ipynb`](http://colab.research.google.com/github/epfml/ML_course/blob/main/labs/ex01/npprimer.ipynb)
...
We provide you with an example of a notebook for [this first lab](https://github.com/epfml/ML_course/tree/main/labs/ex01), but if you want to see some more examples already, feel free to take a look at
